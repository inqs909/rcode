...
subtitle: "Descriptive stats & visualizations for quantitative variables (mean/median, spread, hist/box/scatter)"
description: |
  A student-friendly reference with concise explanations, runnable examples,
  and copy-paste templates for summarizing and visualizing numerical data in R.
format:
  html:
    toc: true
    toc-depth: 3
