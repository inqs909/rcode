...
subtitle: "Explaining variation, simple & multiple linear models, categorical predictors, correlation, prediction"
description: |
  A student-friendly Quarto handout based on your lecture outline. Includes the
  penguins and Taylor datasets, runnable examples, and copy‑paste templates.
format:
  html:
    toc: true
    toc-depth: 3
...
DT::datatable(head(penguins, 6), options = list(dom = "p"))
```
